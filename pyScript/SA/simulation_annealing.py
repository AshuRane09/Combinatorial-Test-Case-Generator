...
#------------------------------------------------------------------------------------------------------------
def runSA():
    print("Hi Hello how are you TLBO....")
    ...
    no_of_iter = 300 #int(input("Enter the number of iterations : "))    
    ...
    ideal = 8 #(no_of_dimensions) * (no_of_dimensions - 1) // 2
    ...
    while T > 0.000001 and len(pairs) > 0 and no_of_iter > 0:
    ...
    remove_unwanted_values_from_map(selected_conf)
